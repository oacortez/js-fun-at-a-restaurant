...
inStock = 40 * 2; // this math operator will times 40 * 2 which will return 80 and will Reassign as the new value for inStock variable.
...
var shouldOrderMore = inStock < 20 // This will create a boolean value because we are using a comparison operator. Which states if inStock is less
                                  // 20 it would create a true value but inStock is value at 80 and is more then 20 so it would convert to false.
...
var vegetables = ["Carrots", "Onions", "Tomato", "Cucumber", "Green peper"];
...
var fruits = ["Orange", "Banana", "Apple", "Kiwi", "Cherry", "Grapes", "Pear"];
